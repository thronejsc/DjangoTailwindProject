...
urlpatterns = [
    ...
    path('publisher/article-list/pending/<int:article_id>', views.review_pending_article, name='review_article'),
    ...
    path('searchdoc/', views.search_documents, name='search_documents'),
